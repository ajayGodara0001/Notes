...
function AddNote() {
    ...
    const addNote = async () => {
        await axios.post(`${ import.meta.env.VITE_BACKEND_URI}/api/addnote`, {
            title, content, tags
        ...
        <>
            <div className="bg-fuchsia-50 shadow-lg rounded-lg p-6 border border-blue-300 mx-4 md:mx-20 lg:mx-60 mt-5 flex flex-col">
                ...
                <div className="flex flex-col">
                    ...
                    <input 
                        type="text"
                        className='bg-gray-300 w-full md:w-96 lg:w-full py-2 rounded-lg px-3 text-black font-normal'
                ...
                <div className='mt-4'>
                    ...
                    <textarea
                        ...
                        className='px-3 py-2 mb-3 bg-gray-300 w-full md:w-96 lg:w-full mt-2 rounded-md text-black'
                        value={content}
                    />
                </div>
                ...
                <div className='bg-transparent mt-3 flex relative'>
                    <input
                        ...
                        className='bg-gray-300 w-full md:w-96 lg:w-full py-2 rounded-md px-3 text-black font-normal'
